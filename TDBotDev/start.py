...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        try:
            ...
            if not is_premium and user_id != OWNER_ID and not basic.startswith("yu3elk") and SHORTLINK_API:
        ...
        for msg in messages:
            ...
            try:
                ...
                tdbotdev_msgs.append(copied_msg)
            except:
                pass
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/TDBotDev/50")],
            ...
            if not await is_sub(client, user_id, chat_id):
                try:
                    ...
                    return await temp.edit(
                        f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @TDBotDev</i></b>\n"
